...
public class BinaryShardedJedis extends Sharded<CuckooJedis, JedisShardInfo> implements
    BinaryJedisCommands {
  ...
  public void disconnect() {
    for (CuckooJedis cuckooJedis : getAllShards()) {
  ...
  protected CuckooJedis create(JedisShardInfo shard) {
    return new CuckooJedis(shard);
  }

  @Override
  public String set(final byte[] key, final byte[] value) {
    CuckooJedis j = getShard(key);
  ...
  public Object sendCommand(ProtocolCommand cmd, byte[]... args) {
    ...
    CuckooJedis j = getShard(sampleKey);
