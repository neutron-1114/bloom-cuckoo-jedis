...
public final class Protocol {
  ...
  public static enum Command implements ProtocolCommand {
    ...
    CF_ADD("CF.ADD"), CF_ADDNX("CF.ADDNX"), CF_INSERT("CF.INSERT"), CF_EXISTS("CF.EXISTS"),
    CF_INSERTNX("CF.INSERTNX"), CF_MEXIST("CF.MEXISTS"), CF_COUNT("CF.COUNT"), CF_DEL("CF.DEL"),
    CF_DUMP("CF.SCANDUMP"), CF_RESERVE("CF.RESERVE"), CF_LOADCHUNK("CF.LOADCHUNK"),
    BF_RESERVE("BF.RESERVE"), BF_ADD("BF.ADD"), BF_MADD("BF.MADD"), BF_INSERT("BF.INSERT"),
    BF_EXISTS("BF.EXISTS"), BF_MEXISTS("BF.MEXISTS"), BF_SCANDUMP("BF.SCANDUMP"), BF_LOADCHUNK("BF.LOADCHUNK");
